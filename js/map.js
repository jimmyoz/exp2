...
//'sk.eyJ1Ijoid2FuZ3NoZW5nMTA5IiwiYSI6ImNreXRyOWVwMzFnNG0ydXBocWs2bmNudHcifQ.hjdkrUH6uPQxLfhH5B9Rfw';
//var blankStyle = {
//    version: 8,
//    name: "BlankMap",
//    sources: {},
...
map.on('load', function () {
    ...
    //取nodes
    var apiUrl = 'http://112.35.192.13:8081/ette/get_nodes_location';
    ...
    //取signers
    var apiUrl = 'http://112.35.192.13:8081/ette/get_common_signers';
    var opt = { "current_page": 1, "items_per_page": 100 };
    var jsonData = JSON.stringify(opt);
    $.ajax(
        {
