...
function goToBlockInfosByNumber() {
    $.ajax(
        {
            url: 'http://112.35.192.13:7000/v1/block?number=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
...
function goToBlockInfosByHash() {
    ...
    $.ajax(
        {
            url: 'http://112.35.192.13:7000/v1/block?hash=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
            beforeSend: function (xhr) {
...
function goToTxInfos() {
    $.ajax(
        {
            url: 'http://112.35.192.13:7000/v1/transaction?hash=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
            beforeSend: function (xhr) {
...
function goToAddress() {
    ...
    var eth_node_url = 'http://112.35.181.215:8545';//35.76.239.114
