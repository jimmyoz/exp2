...
function getAddressInfos() {
    ...
    $.ajax(
        {
            url: 'http://112.35.192.13:8081/ette/get_address_type',
            type: 'POST',
            dataType: "json",
            data: jsonData,
    ...
    var eth_node_url = 'http://112.35.181.215:8545';
...
function goPage(iType) {
    ...
    $(".pageInfo").html(iPage + "/" + pages);
    var apiUrl = 'http://112.35.192.13:8081/ette/get_address_trx';//?max_block=' + block_height + '&current_page=' + iPage + '&items_per_page=' + pageSize;
...
function goPage1(iType) {
    ...
    $(".pageInfo").html(iPage1 + "/" + pages1);
    var apiUrl = 'http://112.35.192.13:8081/ette/get_signed_blocks';
